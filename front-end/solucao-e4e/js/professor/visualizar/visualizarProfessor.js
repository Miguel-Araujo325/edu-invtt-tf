...
async function buscarProfessor() {
    ...
    const resposta = await fetch(`http://54.159.90.230/api/usuarios/professor/paginado?page=${paginaAtual}` + Filters.buildQueryString(), {
        method: 'GET',
        headers: {
...
async function deletarProfessor(id) {
    const respostaDelete = await fetch(`http://54.159.90.230/api/usuarios/Professor/${id}`, {
        method: "DELETE",
        headers: {
...
async function atualizarMetaProfessor(id) {
    try {
        ...
        const resposta = await fetch(`http://54.159.90.230/api/metas/${id}`, {
            method: "PUT",
            body: meta,
...
async function importarDados() {
    ...
    try {
        ...
        const response = await fetch('http://54.159.90.230/api/archive/txt/usuarios', {
            method: 'POST',
            body: formData,
            headers: {
                'Authorization': `Bearer ${sessionStorage.getItem('token')}`
...
async function exportarDados() {
    ...
    try {
        const response = await fetch(`http://54.159.90.230/api/archive/csv/usuarios/${tipo}`, {
            method: 'GET',
            headers: {
